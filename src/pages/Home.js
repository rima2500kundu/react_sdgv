            ...
            <>
                {/* <header className="full_width main_header navbar-fixed-top sticky" id="header">
                    <div className="container d-flex">
                        <div className="head_logo"><a href="index.html"><img src="images/logo.png" alt="logo" /></a></div>
                ...
                <section className="full_width trusted_by hme_trst_slider">
                    <div className="container">
                        ...
                        <div className="regular slider" id="trusted_slider">
                            <div><div className="trstd_sldr_row"><img src="images/Alimentation_Couche-Tard.png" alt="logo" /></div></div>
                            <div><div className="trstd_sldr_row"><img src="images/Amazon_logo.png" alt="logo" /></div></div>
                            <div><div className="trstd_sldr_row"><img src="images/apple_client.png" alt="logo" /></div></div>
                            <div><div className="trstd_sldr_row"><img src="images/AT-T.png" alt="logo" /></div></div>
                            <div><div className="trstd_sldr_row"><img src="images/Chevron_Corporation.png" alt="logo" /></div></div>
                            <div><div className="trstd_sldr_row"><img src="images/Cisco_Systems.png" alt="logo" /></div></div>
                            <div><div className="trstd_sldr_row"><img src="images/Enbridge.png" alt="logo" /></div></div>
                            <div><div className="trstd_sldr_row"><img src="images/Exxon_Mobil.png" alt="logo" /></div></div>
                            <div><div className="trstd_sldr_row"><img src="images/ford.png" alt="logo" /></div></div>
                            <div><div className="trstd_sldr_row"><img src="images/General_Electric.png" alt="logo" /></div></div>
                            <div><div className="trstd_sldr_row"><img src="images/Home_Depot.png" alt="logo" /></div></div>
                            <div><div className="trstd_sldr_row"><img src="images/IBM_logo.png" alt="logo" /></div></div>
                            <div><div className="trstd_sldr_row"><img src="images/Manulife__Financial.png" alt="logo" /></div></div>
                            <div><div className="trstd_sldr_row"><img src="images/reference_johnson-johnson_logo.png" alt="logo" /></div></div>
                            <div><div className="trstd_sldr_row"><img src="images/toyota.png" alt="logo" /></div></div>
                            <div><div className="trstd_sldr_row"><img src="images/Walgreens_ Boots_ Alliance.png" alt="logo" /></div></div>
                            <div><div className="trstd_sldr_row"><img src="images/Walmart-Logo_client.png" alt="logo" /></div></div>
                        </div>
                    </div>
                </section>
